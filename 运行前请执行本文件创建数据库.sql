...
CREATE TABLE `ims_user` (
  ...
  `users_role` tinyint(3) unsigned NOT NULL,
  ...
  `gmt_visit` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
LOCK TABLES `ims_user` WRITE;
/*!40000 ALTER TABLE `ims_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `ims_user` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-08-21  9:46:05
